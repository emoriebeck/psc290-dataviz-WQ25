...
## [Proportions / Probability]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/blue-top-sm.png" background-size="100%" .smaller}
...
# Point Estimates  
## [Point Estimates]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [Marginal Means from Model Predictions]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [Point Estimates and Marginal Means]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [`stat_halfeye()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [`stat_eye()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [`stat_gradientinterval()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [`stat_dots()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [`stat_dots(): Change number of dots`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [`stat_dots(): Three Layouts`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [`stat_dotsinterval()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [`stat_halfeye()`+ `stat_dots()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top-sm.png" background-size="100%" .smaller}
...
## [Simple Slopes]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top-sm.png" background-size="100%" .smaller}
...
## [Simple Slopes: `geom_line()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top-sm.png" background-size="100%" .smaller}
...
b_df3 %>%
  ggplot(aes(x = age, y = pred)) + 
    geom_line(
      aes(
        color = marital
        , group = interaction(marital, boot)
        )
      , alpha = .2
      , size = .25
      ) + 
...
## [Simple Slopes: `geom_lineribbon()` summaries]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top-sm.png" background-size="100%" .smaller}
...
b_df3 %>%
  group_by(marital, age) %>%
  median_qi(pred) %>%
  ggplot(aes(x = age*10, y = pred, ymin = .lower, ymax = .upper)) +
...
## [Simple Slopes: `geom_lineribbon()` summary bands]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top-sm.png" background-size="100%" .smaller}
...
## [Simple Slopes: `geom_lineribbon()` sample bands]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top-sm.png" background-size="100%" .smaller}
...
```{r, echo = F}
b_df3 %>%
  ggplot(aes(x = age*10, y = pred, fill = marital)) + 
  stat_lineribbon(alpha = .25) + 
  scale_fill_brewer(palette = "Dark2") + 
  my_theme()
```
...
## [Simple Slopes: `geom_lineribbon()` gradient samples]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top-sm.png" background-size="100%" .smaller}
...
## [Ensemble Displays]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top-sm.png" background-size="100%" .smaller}
...
## [Hypothetical Outcome Plots (HOPs)]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/orange-top-sm.png" background-size="100%" .smaller}
...
gsoep_ex3 %>%
  ggplot(aes(y = marital, x = SRhealth)) + 
    ...
    scale_color_manual(values = c("seagreen3", "darkorange")) + 
    my_theme()
```
