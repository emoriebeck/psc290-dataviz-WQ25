...
## Structure for today 
* Today we'll talk about visualizing proportions. 
* Our readings discussions will be folded into the application portion, with lots of breaks in lecture / demonstration to practice yourselves. 
* Download the materials today at [https://bit.ly/dataviz25-03](https://bit.ly/dataviz25-03). 
* Open up the week-03-workbook-students.qmd, which will have blanks for you to complete the built-in exercises. 
...
## [Pie Charts]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/blue-top.png" background-size="100%"}
...
## [Pie Charts]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/blue-top.png" background-size="100%" .smaller}
...
## [Stacked Bar Charts]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top.png" background-size="100%"}
...
## [Stacked Bar Charts]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top.png" background-size="100%" .smaller}
...
## [Side-by-Side Bar Charts]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top.png" background-size="100%"}
...
## [Side-by-Side Bar Charts]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top.png" background-size="100%" .smaller}
...
gsoep %>%
  ...
  mutate(prop = n/sum(n)) %>%
  ggplot(aes(x = year, y = prop, fill = marital)) + 
    geom_col(position = "dodge", color = "black") + # geom_bar(stat = "identity", color = "black", position = "dodge") + 
    theme_classic()
```
:::
:::::
...
:::
:::::
## [Bar Charts and Density Across Continuous Variables]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/yellow-top.png" background-size="100%"}
...
## [Bar Charts and Density Across Continuous Variables]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/yellow-top.png" background-size="100%" .smaller}
...
## [Stacked Area Charts]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/yellow-top.png" background-size="100%" .smaller}
...
## [Stacked Area Charts]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/yellow-top.png" background-size="100%"}
...
::: column
```{r, echo = T, fig.show='hide', fig.align='center', fig.dim= c(6,4), out.width = "90%"}
#| code-line-numbers: "|21|15-16,18-20|24-28"
gsoep %>%
  filter(!is.na(SRhealth) & age >= 18 & age <= 100) %>% # random
  group_by(age, SRhealth) %>%
  tally() %>%
...
## [Total Density Plots]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/yellow-top.png" background-size="100%"}
...
## [Total Density Plots]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/yellow-top.png" background-size="100%" .smaller}
...
## [Nested Proportions]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top.png" background-size="100%"}
...
## [Nested Proportions]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top.png" background-size="100%" .smaller}
...
## [Mosaic Plots]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top.png" background-size="100%" .smaller}
...
## [Treemap]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top.png" background-size="100%" .smaller}
