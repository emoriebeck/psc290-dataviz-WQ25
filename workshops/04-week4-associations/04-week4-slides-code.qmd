...
## [Scatterplots]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/blue-top.png" background-size="100%"}
...
## [Scatterplots - Basics]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/blue-top.png" background-size="100%"}
...
## [Scatterplots - Basics]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/blue-top.png" background-size="100%" .smaller}
...
## [Correlations and Correlelograms]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top.png" background-size="100%"}
...
## [Correlations and Correlelograms]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top.png" background-size="100%" .smaller}
...
- [Here's](https://sape.inf.usi.ch/quick-reference/ggplot2/shape) all the ggplot shapes. I suggest checking out shape 21. 
- Be thoughtful about your legends 
- Be thoughtful about your axis labels and titles 
- Hint: you can borrow some code from the heat map

:::
::: {.column}

```{r, echo = T, fig.show='show', fig.align='center', fig.dim= c(6,4), out.width="100%"}
r_data$r[[1]] %>%
...
## [Models + `broom`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top.png" background-size="100%" }
...
## [Models + `broom::tidy()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top.png" background-size="100%" } 
...
## [Models + `broom::tidy()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top.png" background-size="100%" .smaller}
...
```{r, echo = T, eval = F, fig.align='center', fig.dim= c(6,4), out.width="100%"}
#| code-line-numbers: "8,14|6|23-33"
nested_m %>%
  select(study, tidy) %>%
  unnest(tidy) %>%
  mutate_at(vars(estimate, conf.low, conf.high), exp) %>%
...
## [Models + `broom::`glance()`]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/yellow-top.png" background-size="100%" .smaller}
...
## [Models + `broom::`glance()`]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/yellow-top.png" background-size="100%"}
...
## [Models + `broom::augment()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/orange-top.png" background-size="100%" .smaller}
...
## [Model Predictions]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top.png" background-size="100%" .smaller} 
...
## [Model Predictions]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/red-top.png" background-size="100%"}
...
* But there are lots of packages to automate much of this: 
  ...
  + etc.
* Interested in learning more about functional programming and how to improve your workflow for running models and extracting effects? 
  + [Data Cleaning FQ23, Workflow](https://emoriebeck.github.io/psc290-data-FQ23/04-week4-workbook.html#example)
  + [Data Cleaning FQ23, Functions & `purrr`](https://emoriebeck.github.io/psc290-data-FQ23/05-week5-workbook.html)
  + [Data Cleaning FQ23, Review](https://emoriebeck.github.io/psc290-data-FQ23/06-week6-workbook.html#purrr)
  + [Data Cleaning FQ23, Automated Tables](https://emoriebeck.github.io/psc290-data-FQ23/08-week8-workbook.html)
