...
::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics("03-images/info-proc.jpeg")
```
:::
::::
...
```{r, fig.align='center'}
knitr::include_graphics("03-images/vis-vars.png")
```
...
```{r, fig.align='center', out.width='100%'}
  knitr::include_graphics("03-images/gestalt.png")
```

----

```{r, fig.align='center', out.width='100%'}
  knitr::include_graphics("03-images/gestalt-list.png")
```

----

```{r, fig.align='center', out.width='100%'}
  knitr::include_graphics("03-images/gestalt-proximity.png")
```

----

```{r, fig.align='center', out.width='100%'}
  knitr::include_graphics("03-images/gestalt-closure.png")
```

----

```{r, fig.align='center', out.width='100%'}
  knitr::include_graphics("03-images/gestalt-similarity.png")
```
...
```{r, fig.align='center', out.width='100%'}
  knitr::include_graphics("03-images/gestalt-figure-ground.png")
```

----

```{r, fig.align='center', out.width='100%'}
  knitr::include_graphics("03-images/gestalt-symmetry.png")
```

----

```{r, fig.align='center', out.width='100%'}
  knitr::include_graphics("03-images/gestalt-continuity.png")
```
...
```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-1.png")
```
----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-2a.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-2b.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-2c.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-2d.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-3a.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-3b.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-3c.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-3d.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-4.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-4b.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-4c.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-5a.png")
```

----

```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-5b.png")
```
...
```{r, fig.align='center', out.width='100%'}
knitr::include_graphics("03-images/prin-5c.png")
```
...
```{r, echo = T, fig.show='hide', fig.align='center', fig.dim= c(6,4)}
ipcs_data %>%
  filter(SID == "216") %>%
  ggplot(mapping = aes(
    x = purposeful
...
```{r, echo = F, fig.show='show', fig.align='center', fig.dim= c(6,4)}
ipcs_data %>%
  filter(SID == "216") %>%
  ggplot(mapping = aes(
    x = purposeful
...
```{r, echo = T, fig.align='center', fig.dim= c(6,4)}
#| code-line-numbers: "|4"
ipcs_data %>%
  filter(SID == "216") %>%
...
::: {.column}
```{r, echo = F, fig.align='center', fig.dim= c(6,4)}
ipcs_data %>%
  filter(SID == "216") %>% 
  select(SID, Full_Date, argument, interacted, study, tired) %>%
  pivot_longer(
...
```{r , echo = T, fig.show='hide', fig.align='center', fig.dim= c(4,2.75)}
#| code-line-numbers: "|5"
ipcs_data %>%
...
ipcs_data %>%
  ...
  ggplot(mapping = aes(x = purposeful, y = happy)) + 
    ...
    scale_y_continuous(limits = c(1,7), breaks = seq(1,5,2)) + 
    geom_jitter(width = .1, height = .1, alpha = .25) + 
    geom_boxplot(aes(x = 6, y = happy)) + 
    geom_boxplot(aes(y = 6, x = purposeful)) +
    geom_smooth(method = "lm", formula = y ~ x, se = F, color = "blue") + 
    theme_classic() # I just hate grey backgrounds
```
:::
...
:::: {.columns}
::: {.column}
```{r , echo = T, fig.show='hide', fig.align='center'}
...
::: {.column}
```{r , echo = F, fig.align='center', fig.dim= c(6,4), out.width="100%"}
ipcs_data %>%
  filter(SID == "216") %>%
  select(SID, beep, afraid:content) %>%
  pivot_longer(
...
::: {.column}
```{r , echo = F, fig.align='center', fig.dim= c(6,6), out.width="100%"}
ipcs_data %>%
  filter(SID == "216") %>%
  select(SID, beep, afraid:content) %>%
  pivot_longer(
